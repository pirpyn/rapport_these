...
\newcommand{\doctitleeng}{Simulation of a coated objet in the frequency domain by a high order impedance boundary condition}
...
\hypersetup{
    ...
    pdfproducer={pdflatex (MiKTeX 2020)}, % producer of the document
...
\begin{document}
    ...
    \frontmatter
        ...
        \include{liminaires}
        % Quand ce sera fini
        % \input{tex/liminaires/personnel}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \mainmatter
        \include{chapitre_0} % intro
        \setcounter{mtc}{3} % "Corrige" les minitocs décallées à cause des chapter* (ex : Intro)
        \include{chapitre_1} % Les maths
        \include{chapitre_2} % CSU
        \include{chapitre_3} % Plan
        \include{chapitre_4} % Cylindre
        \include{chapitre_5} % Sphere
        \include{chapitre_6} % Equation intégrales
        \include{conclusion}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \backmatter
        \include{annexes}
