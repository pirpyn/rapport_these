...
\begin{document}
    ...
    \mainmatter
        ...
        \include{chapitre_1} % Impedance & reflexion
        \include{chapitre_2} % CIOE
        \include{chapitre_3} % CSU
        \include{chapitre_4} % Equation integrales
        %\include{chapitre_5} % Restes inutiles
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \backmatter
        \appendix
