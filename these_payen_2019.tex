...
\newcommand{\dockeywordseng}{Electromagnetism (EM), Impedance, Sufficient uniqueness conditions (SUC), Constrained optimisation, Radar cross section (RCS), Finite elements method (FEM), Integral equation (EFIE,MFIE)}
...
\begin{document}
    ...
    \mainmatter
        ...
        \include{chapitre_1} % CSU
        \include{chapitre_2} % Plan
        \include{chapitre_3} % Cylindre
        \include{chapitre_4} % Sphere
        \include{chapitre_5} % Equation intégrales
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \backmatter
        \appendix
        \pagestyle{annexe}
