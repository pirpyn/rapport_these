\section{CHoix des coefficients de la CI3 par moindres carrés sur l'impédance}
  ...
  \subsection[Choix de la fonction Jz]{Choix de la fonction \(J_Z\)}
    Ce premier choix consiste à minimiser l'erreur entre la matrice d'impededance exact et celle approchée par la CIOE.
    \begin{defn}
