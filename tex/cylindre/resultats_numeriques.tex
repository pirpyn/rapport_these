...
%    pour approcher l'impédance exacte du cylindre.
  ...
  Il est évident que la CI3 n'est pas une bonne approximation du multiplicateur de Fourier de l'opérateur de Calderón, par exemple quand \((n,k_z) = (0,0)\).
  ...
  \pagebreak
  Les tableaux \ref{tab:cylindre:hoppe:62:erreurs_Z} contiennent les valeurs des erreurs relatives au carré de \(\hat\mZ\). 
