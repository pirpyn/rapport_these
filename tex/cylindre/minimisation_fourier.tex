\section[Choix 2 du calcul des coefficients de la CI3]{Choix des coefficients de la CI3 par moindres carrés sur les coefficients de la série de Fourier}
  ...
  \subsection[Choix de la fonction JR]{Choix de la fonction \(J_R\)}
    ...
    \begin{prop}
      Soient \(X = (a_0,a_1,a_2,b_1,b_2)^t \in \CC^5\), \((n,k_z)\) fixé et \(\hat\mR_{ex}\) la matrice définie en \ref{def:cylindre:minimisation:matrices_MR}.
    ...
    \begin{defn}
      ...
      \begin{equation*}
        ...
        \end{bmatrix}.
      \end{equation*}
      On définit \(\tilde{g}\) le vecteur colonne \(\CC^{4N_{n}N_{k_z}}\) tel que
      \begin{equation*}
        \tilde{g} = 
        \begin{bmatrix}
