\section[Opérateur de Calderón pour un cylindre infini]{Expressions exactes des matrices d'impédance et des matrices de réflexion pour un cylindre infini}
  ...
  Soit \(\hat\vE\) la transformée de Fourier telle que
  \begin{equation*}
  ...
  \begin{proof}
    ...
    On trouve exactement les mêmes résultats pour \(\hat{\cH_z}\) dans la couche de matériaux. 
...
\begin{REM}
  même à haute fréquence ?
\end{REM} 
\begin{REP}
  Je ne sais pas. Question à prévoir.
\end{REP}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \subsection{Expression du symbole de l'opérateur de Calderón pour une couche}
    ...
    \begin{proof}
      ...
      du conducteur parfait \(\hat \vE(r_0,n,k_z) = 0\) dans \eqref{eq:imp_fourier:cylindre:Et}, donc
      \begin{equation*}
        \mJ_{E}(r_0,n,k_z)
        \begin{bmatrix}
          c_1(n,k_z) \\
...
\end{REM}
\begin{REP}
  Je ne sais pas. Pas le temps.
\end{REP}
      On suppose donc simplement \(\mH_{\cH}(r_1,n,k_z) - \mJ_{\cH}(r_1,n,k_z)\mJ_{E}(r_0,n,k_z)^{-1}\mH_{E}(r_0,n,k_z)\) inversible, la matrice \(\hat\mZ(n,k_z)\) telle que \(\hat\vE_t(r_1,n,k_z) = \hat\mZ(n,k_z) \hat{\vJ_t}(r_1,n,k_z)\) est alors
      ...
      \end{multline*}
      Comme on a supposé la matrice \(\mH_E(r_0,n,k_z)\) inversible, on peut simplifier par cette matrice d'où la proposition.
  ...
  \subsection{Expression de la matrice d'impédance pour plusieurs couches}
    ...
    \begin{prop}%[Corollaire aux théorèmes de transfert et de relèvement.]{}~
      ...
      \begin{align*}
      \hat{\vE_t}(r_{p-1}^+,n,k_z) &= \hat\mZ_{p-1}(n,k_z)(\hat\vJ_t(r_{p-1}^+,n,k_z)),
      \\
      \hat{\vE_t}(r_{p}^-,n,k_z) &= \hat\mZ_{p}(n,k_z)(\hat\vJ_t(r_{p}^-,n,k_z)).
      \end{align*}
  ...
  \subsection{Expression des coefficients de la série de Fourier}
    ...
    \begin{prop}%[Théorème de transfert]~
      ...
      \begin{align*}
        \hat{\vE_t}(r_{p}^+,n,k_z) &= \mN_{E}(r_p^+,n,k_z,\hat\mR_{p+1}(n,k_z))\vect{C}_{p+1}(n,k_z),
        \\
    ...
    \begin{proof}
      ...
      \begin{align*}
        \hat{\vE_t}(r_p^+,n,k_z) &= \mN_{E}(r_p^+,n,k_z,\hat\mR_{p+1}(n,k_z))\vect{C}_{1}^+(n,k_z),
        \\
        \hat{\vE_t}(r_p^-,n,k_z) &= \mJ_E(r_p^-,n,k_z)\vect{C}_{1}^-(n,k_z) + \mH_E(r_p^-,n,k_z)\vect{C}_{2}^-(n,k_z),
      \end{align*}
      \begin{align*}
        \hat{\vJ_t}(r_p^+,n,k_z) &= \mN_{\cH}(r_p^+,n,k_z,\hat\mR_{p+1}(n,k_z))\vect{C}_{1}^+(n,k_z),
        \\
        \hat{\vJ_t}(r_p^-,n,k_z) &= \mJ_\cH(r_p^-,n,k_z)\vect{C}_{1}^-(n,k_z) + \mH_\cH(r_p^-,n,k_z)\vect{C}_{2}^-(n,k_z).
      \end{align*}
    ...
    \begin{prop}%[Théorème de relévement]~
      ...
      \begin{align*}
        \hat{\vE_t}(r_{p}^-,n,k_z) &= \mN_{E}(r_p^-,n,k_z,\hat\mR_{p}(n,k_z))\vect{C}_{p}(n,k_z),
        \\
      ...
      alors
      \begin{align*}
        \hat{\vE_t}(r_{p}^+,n,k_z) &= \mN_{E}(r_p^+,n,k_z,\mathfrak{T}_p(r_p^+,r_p^-,n,k_z,\hat\mR_{p}(n,k_z)))\vect{C}_{p+1}(n,k_z),
        \\
        \hat{\vE_t}(r_{p}^+,n,k_z) &= \mN_{\cH}(r_p^+,n,k_z,\mathfrak{T}_p(r_p^+,r_p^-,n,k_z,\hat\mR_{p}(n,k_z)))\vect{C}_{p+1}(n,k_z).
      \end{align*}
    \end{prop}
  ...
  \subsection{Applications numériques}
    ...
    \begin{figure}[!hbt]
      ...
      \caption[Convergence de l'opérateur Calderón du cylindre vers celui du plan quand le rayon augmente.]{\(\eps = 6\), \(\mu = 1\), \(d=0.0225\)m, \(f=1\)GHz}
    ...
    %   \caption[Module des coefficients de Fourier de l'opérateur de Calderon pour une couche cylindrique sans perte]{\(\eps = 6, \mu = 1, d=0.0225\text{m}, f=1\text{GHz}\)}
