\section{Expressions exactes des matrices d'impédance et des matrices de réflexion pour un cylindre infini}
  ...
  \subsection{Expressions des champs tangentiels dans chaque couche}
    ...
    \begin{prop}
      Dans chaque couche \(r_{m-1}\le r < r_m\), il existe \((c_i(n,k_z))_{1\le i\le 4}\) telles que les composantes en \(\vect{e_\theta},\vect{e_z}\) des champs, dites composantes tangentielles par abus de langage, sont
      \begin{subequations}
        \begin{align}
  ...
  \subsection{Expression des coefficients de la série de Fourier}
    ...
    \begin{prop}%[Théorème de transfert]~
      ...
      \begin{align*}
        ...
        \\
        \vect{e_r}\pvect\vH(r_{p}^-,n,k_z) &= \mN_{\cH}(r_p^-,n,k_z,\mathfrak{T}_p(r_p^-,r_p^+,n,k_z,\hat\mR_{p+1}(n,k_z)))\vect{C}_{p}(n,k_z).
      \end{align*}
    \end{prop}
    ...
    \begin{proof}
      ...
      On suppose que la matrice du membre de droite est inversible et alors
      \begin{equation*}
    ...
    \begin{prop}%[Théorème de relévement]~
      ...
      \begin{align*}
        ...
        \\
        \vect{e_r}\pvect\vH(r_{p}^-,n,k_z) &= \mN_{\cH}(r_p^-,n,k_z,\hat\mR_{p}(n,k_z))\vect{C}_{p}(n,k_z).
      \end{align*}
      ...
      \begin{align*}
        ...
        \\
        \vE_t(r_{p}^+,n,k_z) &= \mN_{\cH}(r_p^+,n,k_z,\mathfrak{T}_p(r_p^+,r_p^-,n,k_z,\hat\mR_{p}(n,k_z)))\vect{C}_{p+1}(n,k_z).
      \end{align*}
    \end{prop}
