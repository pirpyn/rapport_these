\section{Expressions exactes des matrices d'impédance et des matrice de réflexions pour un cylindre infini}
  ...
  \subsection{Expression de la patrice d'impédance pour plusieurs couches}
    ...
    \begin{thm}
      % Il existe un matrice de propagation \(\hat\mP\) dans la couche permettant de déduire une relation entre les composantes de \(\hat\vE_t\) et \(\vn \pvect \hat\vH\) à une interface en fonction de la matrice d'impédance \(\hat\mZ\).
