\section{Expressions exactes des matrices d'impédance et des matrice de réflexions pour un cylindre infini}
  ...
  \subsection{Expressions des champs tangentiels dans chaque couche}
    ...
    \begin{prop}
      ...
      Si \(\mu(r)\eps(r) \in \CC\backslash\RR\), alors les matrices \(\mJ_E(r,n,k_z)\), \(\mH_E(r,n,k_z)\)  sont inversibles pour tout couple \((n,k_z)\).
    ...
    Pour les matrices \(\mJ_H(r,n,k_z)\), \(\mH_H(r,n,k_z)\), on a
    \begin{align}
      \det(\mH_E(r,n,k_z)) &= -\frac{i\w\mu(r)}{k_3(r)}H_n^{(2)}(k_3(r)r)H_n^{(2)}{}'(k_3(r)r)
      \\
      \det(\mH_H(r,n,k_z)) &= -\frac{i\w\eps(r)}{k_3(r)}H_n^{(2)}(k_3(r)r)H_n^{(2)}{}'(k_3(r)r)
  ...
  \subsection{Expression de la matrice d'impédance pour plusieurs couches}
    ...
    Soient \(r_p\) le rayon de l'interface \(p\), \(r_p = r_0 +\sum_{i=1}^{p} d_{i}\). On dit que l'on se trouve dans la couche \(p\) si \(r_{p-1} \le r \le r_p \).
    ...
    \begin{proof}
      ...
      On suppose que les matrices \(\mM_{\mJ}(r_p,n,k_z,\hat\mZ_p(n,k_z)), \mM_{\mH}(r_p,n,k_z,\hat\mZ_p(n,k_z))\) sont inversibles pour tout \((n,k_z)\) donc
      \begin{equation*}
        \begin{bmatrix}
          c_2(n,k_z) \\
          c_4(n,k_z)
    ...
    \begin{proof}
      Même méthodologie que pour la proposition \ref{prop:cylindre:transfert}.
    \end{proof}
  ...
  \subsection{Expression des coefficients de la série de Fourier}
    ...
    \begin{prop}%[Théorème de relévement]~
      ...
      \begin{align*}
        ...
        \\
        \vE_t(r_{p}^+,n,k_z) &= \mN_{H}(r_p^+,n,k_z,\mathfrak{T}_p(r_p^+,r_p^-,n,k_z,\\hatmR_{p}(n,k_z)))\vect{C}_{p+1}(n,k_z)
      \end{align*}
    \end{prop}
