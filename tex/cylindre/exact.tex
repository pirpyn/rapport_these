\section{Expressions exactes des matrices d'impédance et des matrice de réflexions pour un cylindre infini}
  ...
  \subsection{Applications numériques}
    ...
    \end{figure}
    Pour une couche de matériau sans pertes, la matrice \(\hat\mZ\) est imaginaire pure, donc les parties réelles ne sont pas tracées. On voit donc que l'impédance du cylindre tend vers celle du plan quand \(r\) augmente. On peut postuler de ce graphe que pour \(r_0\ge100d\) alors on peut se ramener à un plan infini.
