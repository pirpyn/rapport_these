...
\lettrine{S}{oit} le problème de Maxwell \eqref{eq:pres_th:intro:maxwell} dans le cas d'un objet sphérique de constantes $\eps$ et $\mu$%, éclairé par une onde électro-magnétique  de pulsation $w$ et de nombre d'onde $k$, tel que $k^2 = w^2\eps\mu$
.
