...
\begin{align*}
  ...
  &= %\left(\frac{1}{r\sin\theta}\left[\ddd{\theta}\left(\frac{\sin\theta}{r\sin\theta}\frac{\dd^2}{\dd r\phi}\Psi\right)-\ddd{\phi}\left(\frac{1}{r}\frac{\dd^2}{\dd r\theta}\Psi\right)\right]\right)
   0 ~ \v e_r 
