...
% \subsection{Prise en compte des conditions aux limites}
% Nous allons utiliser les condition aux limites à l'infini afin de déterminer les champs \((\E,\H)\) finaux.
