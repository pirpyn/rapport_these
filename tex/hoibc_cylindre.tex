 ...
 \begin{figure}[!hbt]
          ...
          \begin{tikzpicture}[scale=1]
              \begin{axis}[
                  ...
                  \addplot+ [color=black] table [col sep=semicolon, x={s1}, y={Im(z_ex.tm)}] {tikz/csv/impedance/cylindre/HOPPE_62.z_ex.C_+3.000E-02.csv};

                  \addplot+ [color=blue] table [col sep=semicolon, x={s1}, y={Im(z_ibc0.tm)}] {tikz/csv/impedance/cylindre/HOPPE_62.z_ci.IBC_ibc0_TYPE_C_+3.000E-02_SUC_F.csv};

                  \addplot+ [color=red] table [col sep=semicolon, x={s1}, y={Im(z_ibc3.tm)}] {tikz/csv/impedance/cylindre/HOPPE_62.z_ci.IBC_ibc3_TYPE_C_+3.000E-02_SUC_F.csv};
              \end{axis}
          \end{tikzpicture}
          \begin{tikzpicture}[scale=1]
              \begin{axis}[
                  ...
                  \addplot+ [color=black] table [col sep=semicolon, x={s1}, y={Im(z_ex.te)}] {tikz/csv/impedance/cylindre/HOPPE_62.z_ex.C_+3.000E-02.csv};
                  \addlegendentry{Exact};

                  \addplot+ [color=blue] table [col sep=semicolon, x={s1}, y={Im(z_ibc0.te)},color=] {tikz/csv/impedance/cylindre/HOPPE_62.z_ci.IBC_ibc0_TYPE_C_+3.000E-02_SUC_F.csv};
                  \addlegendentry{CI0};

                  \addplot+ [color=red] table [col sep=semicolon, x={s1}, y={Im(z_ibc3.te)}] {tikz/csv/impedance/cylindre/HOPPE_62.z_ci.IBC_ibc3_TYPE_C_+3.000E-02_SUC_F.csv};
                  \addlegendentry{CI3};                  
              \end{axis}
          \end{tikzpicture}
     ...
     \begin{figure}[!hbt]
          ...
          \begin{tikzpicture}[scale=1]
              \begin{axis}[
                  ...
                  \addplot+ [color=violet] table [col sep=semicolon, x={s1}, y={Im(z_ibc6.tm)}] {tikz/csv/impedance/cylindre/HOPPE_62.z_ci.IBC_ibc6_TYPE_C_+3.000E-02_SUC_F.csv};
              \end{axis}
          \end{tikzpicture}
          \begin{tikzpicture}[scale=1]
              \begin{axis}[
                  ...
                  \addplot+ [color=violet] table [col sep=semicolon, x={s1}, y={Im(z_ibc6.te)}] {tikz/csv/impedance/cylindre/HOPPE_62.z_ci.IBC_ibc6_TYPE_C_+3.000E-02_SUC_F.csv};
                  \addlegendentry{CI6};                   
              \end{axis}
          \end{tikzpicture}
          \caption[CIOE sur empilement de Hoppe & Rahmat-Samii p.~62]{\(\eps = 6, \mu = 1, d=0.0225\text{m}, f=1\text{GHz}, r_0=0.03\text{m}\)}
