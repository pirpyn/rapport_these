...
\section[Opérateur de Calderon pour une sphère]{Expressions exactes des matrices d'impédance et des matrices de réflexion pour une sphère}
  ...
  \subsection{Expressions des champs tangentiels dans chaque couche}
    ...
    En utilisant les fonctions définies précédemment, on a les expressions des coordonnées tangentielles de \(\vE,\vJ = \vect{e_r}\times\vH\).
    \begin{prop}
  ...
  \subsection{Expression de la matrice d'impédance pour une couche}
    ...
    \begin{proof}
      ...
      On suppose donc \(\mh_{\cH}(r_1,n) - \mj_{\cH}(r_1,n)\mj_{E}(r_0,n)^{-1}\mh_{E}(r_0,n)\) inversible, la matrice \(\hat\mZ(n)\) telle que \(\hat\vE_t(r_1,n) = \hat\mZ(n) (\vect{e_r}\pvect\vH(r_1,n))\) est alors
  ...
  \subsection{Expression des coefficients de la série de Fourier}
    ...
    \begin{prop}%[Théorème de transfert]{}~
      ...
      \begin{align*}
        ...
        \\
        \vect{e_r}\pvect\vH(r_{p}^+,n) &= \mN_{\cH}(r_p^+,n,\hat\mR_{p+1}(n))\vect{C}_{p+1}(n).
      \end{align*}
      ...
      \begin{align*}
        ...
        \\
        \vect{e_r}\pvect\vH(r_{p}^-,n) &= \mN_{\cH}(r_p^-,n,\mathfrak{T}_p(r_p^-,r_p^+,n,\hat\mR_{p+1}(n)))\vect{C}_{p}(n).
      \end{align*}
    \end{prop}
    ...
    \begin{proof}
      ...
      \begin{align*}
        ...
        \\
        \vect{e_r}\pvect\vH(r_p^+,n) &= \mN_{\cH}(r_p^+,n,\hat\mR_{p+1}(n))\vect{C}_{1}^+(n),
        \\
        \vect{e_r}\pvect\vH(r_p^-,n) &= \mj_\cH(r_p^-,n)\vect{C}_{1}^-(n) + \mh_\cH(r_p^-,n)\vect{C}_{2}^-(n).
      \end{align*}
    ...
    \begin{prop}%[Théorème de relévement]~
      ...
      \begin{align*}
        ...
        \\
        \vect{e_r}\pvect\vH(r_{p}^-,n) &= \mN_{\cH}(r_p^-,n,\hat\mR_{p}(n))\vect{C}_{p}(n).
      \end{align*}
      ...
      \begin{align*}
        ...
        \\
        \vect{e_r}\pvect\vH(r_{p}^+,n) &= \mN_{\cH}(r_p^+,n,\mathfrak{T}_p(r_p^+,r_p^-,n,\hat\mR_{p}(n)))\vect{C}_{p+1}(n).
      \end{align*}
    \end{prop}
