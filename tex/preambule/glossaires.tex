...
\newglossaryentry{ope-LD}{
  ...
  sort={hodge-LD},
  name={\ensuremath{\LD}},
  description={\( \int_\Gamma \LD( \vec{u})\cdot   \vec{v} := - \int_S \vdivs  \vec{u} \vdivs  \vec{v} \)},
}
\newglossaryentry{ope-LR}{
  type={ope},
  sort={hodge-LR},
  name={\ensuremath{\LR}},
  description={\( \int_\Gamma \LR( \vec{u})\cdot  \vec{v} :=  \int_S \left( \vn \cdot \vrots  \vec{u} \right)\left(\vn \cdot \vrots  \vec{v} \right)\)},
}
...
\newglossaryentry{phy-Mmn}{
  ...
  description={Vecteur harmonique sphérique d'ordre \(m\) \\ & et de degré \(n\) de 1er espèce},
}
\newglossaryentry{phy-Nmn}{
  type={phy},
  sort={Nmn},
  name={\ensuremath{\vec{N_{m,n}}}},
  description={Vecteur harmonique sphérique d'ordre \(m\) \\ & et de degré \(n\) de 2eme espèce},
}
