...
\newglossaryentry{mat-hdiv}{
  type={mat},
  sort={hdiv},
  name={\ensuremath{\operatorname{H}_\mathrm{div}(\OO)}},
  description={espace de Sobolev des fonctions de divergence intégrable sur \(\OO\)},
}
\newglossaryentry{mat-hrot}{
  type={mat},
  sort={hrot},
  name={\ensuremath{\operatorname{H}_\mathrm{rot}(\OO)}},
  description={espace de Sobolev des fonctions de rotationnel intégrable sur \(\OO\)},
}
