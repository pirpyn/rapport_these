...
\newglossaryentry{phy-h}{
  ...
  description={champ magnétique (ou excitation magnétique si normalisé par \(\gls{phy-eta}_0\))},
}
...
\newglossaryentry{phy-eta}{
  ...
  sort={eta},
  name={\ensuremath{\eta}},
  description={impédance diélectrique \(\eta=\sqrt{\mu\slash\eps}\)},
}
...
\newglossaryentry{acr-edo}{
  type={acr},
  name={EDO},
  description={équation aux dérivées ordinaires},
  plural={EDO},
  descriptionplural={équations aux dérivées ordinaires},
