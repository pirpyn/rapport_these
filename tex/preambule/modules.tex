...
\ifdefined\XeTeXfonttype %XeLaTeX
    \usepackage{fontspec}
    \defaultfontfeatures{Ligatures=TeX} % reportedly a good idea, see https://tex.stackexchange.com/a/37251
    \setmainfont[Path = fonts/Roboto/]{Roboto-Regular}
    % \usepackage{polyglossia}
    % \setdefaultlanguage{french}
\else % LaTeX
    \randomcommandthatshouldfail
...
\usepackage{xspace}
\usepackage[%
    %showframe,% Dessine une boite pour voir qui depasse. En mode draft
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{pdflscape} % Pour pouvoir changer l'orientation des pages avec \landscape
    %%% Solution pour avoir un paysage qui point vers l'intérieur du livre
    \makeatletter
