...
\usepackage{pgfplots}
    ...
    \tikzexternalize{these_payen_2019}
    % Le graphique triple asymptote nécesssite 20000 pts, il faut etendre la mémoire
    \tikzset{external/system call={pdflatex --output-directory build \tikzexternalcheckshellescape -extra-mem-top=10000000 -halt-on-error -interaction=batchmode -jobname "\image" "\texsource"}}
