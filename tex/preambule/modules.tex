...
\usepackage{pgfplots}
    ...
    \tikzexternalize[prefix=build/]{these_payen_2019} % Les pdf seront mis dans le dossier suivant
    % Le graphique triple asymptote nécesssite 20000 pts, il faut etendre la mémoire
    \tikzset{external/system call={pdflatex \tikzexternalcheckshellescape -extra-mem-top=10000000 -halt-on-error -interaction=batchmode -jobname "\image" "\texsource"}}
...
\usepackage{makecell} % Permet de mettre des \\ dans un \makecell{}
