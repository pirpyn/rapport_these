...
\newcommand{\ddp}[3][{}]{\dfrac{\text{d}^{#1}#3}{{\text{d}#2}^{#1}}}
\newcommand{\ddr}[3][{}]{\dfrac{\partial^{#1} #3}{{\partial #2}^{#1}}}

%Operator
\newcommand{\Sobolev}[1][{}]{\operatorname{H_{#1}}}
...
\newcommand{\trots}{{{\operatorname{rot}}_t}}
\newcommand{\tvrots}{{\vect{\operatorname{rot}}_t}}
