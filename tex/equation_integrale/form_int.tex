...
\section{Forme variationnelle des équations intégrales}
  ...
  Étant donné \((k,\vE^{inc},\vH^{inc})\), on cherche \(\vJ = \vn \pvect \vH, \vK = \vn \pvect \vE \in \Sobolev[div]^{-1/2}{(\Gamma)}\)  tels que

  Pour tout \(\vect{\phi} \in \Sobolev[div]^{-1/2}(\Gamma)\),
  ...
  \begin{multline}
    ...
    \int_{\Gamma} \vE^{inc}_t(\vx) \cdot \vect{\phi}(\vx) \dd{s}(\vx) =
      ...
      - \frac{i}{k} \int_{\Gamma} \left( \int_{\Gamma}  g(\vx - \vy)\vdivs\vJ(\vy) \dd{s}(\vy) \right)\vdivs \vect{\phi}(\vx) \dd{s}(\vx) \\
  ...
  \begin{multline}
    ...
    \int_{\Gamma} \vH^{inc}_t(\vx) \cdot \vect{\phi}(\vx) \dd{s}(\vx) =
      ...
      + \frac{i}{k} \int_{\Gamma} \left( \int_{\Gamma}  g(\vx - \vy)\vdivs\vK(\vy) \dd{s}(\vy) \right)\vdivs \vect{\phi}(\vx) \dd{s}(\vx) \\
