...
\subsection{Choix de la méthode numérique pour résoudre la minimisation sous contraintes}
  ...
  Nous complétons la figure \ref{fig:imp_fourier:plan:soudais:hoibc_csu} où nous avions déjà observé la précision de la CI3, dont les coefficients étaient alors calculés sans contraintes.
