...
Il existe un \(s_z\) tel que \(\hat\mZ_{ex}(k_0s_z,0.) = \infty\) si \(\eps\mu\in\RR\). En effet, d'après la formule pour une couche de matériau de la définition \ref{def:plan:impedance:1c}, 
% \begin{REM}
...
En discrétisant plus finement l'incidence, peut-être aurions-nous pu éviter cette difficulté.
...
%   FAIT
% \end{REP}
Une condition nécessaire et suffisante pour que \(\hat{\mZ}_{ap}\) ai une asymptote est que la matrice de gauche ne soit pas inversible en \(s_z\).
