...
En effet, d'après la formule pour une couche de matériau
\begin{REM}
  matériaux
\end{REM} 
 de la définition \ref{def:plan:impedance:1c}, 
% \begin{REM}
...
%   FAIT
% \end{REP}
Une condition nécessaire et suffisante pour que \(\hat{\mZ}_{ap}\) ai
\begin{REM}
  ait
\end{REM} 
 une asymptote est que la matrice de gauche ne soit pas inversible en \(s_z\).
