...
Dans la partie précédente, nous avons introduit la fonctionnelle
\begin{REM}
  Idem \hyperlink{REMfonctionnelle}{fonctionnelle}
\end{REM}
...
On développe donc la fonctionnelle
\begin{REM}
  Voir \hyperlink{REMfonctionnelle}{avant}.
