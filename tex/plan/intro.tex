...
On suppose enfin que ces champs \(\vE(\vect{x},t),\vect H(\vect{x},t)\) ont des transformées de Fourier partielles suivant les coordonnées tangentielles et le temps \(\hat{\vE}(k_1,k_2,x_n,\w), \hat{\vect H}(k_1,k_2,x_n,\w)\) (\cite[Théorème de Plancherel, p.~153]{yosida_functional_1995}) telle que
...
A partir de maintenant, la dépendance en \(\w\) sera implicite.
