...
Afin d'utiliser les mêmes conventions que \cite{stupfel_implementation_2015}, on substitue au champ magnétique \gls{phy-h} l’excitation magnétique \(\gls{phy-h2} = \gls{phy-eta0} \gls{phy-h}\). Les équations de Maxwell harmoniques sont en définitive
\begin{equation}
    \left\lbrace
    \begin{matrix}
