\section{Approximation par une CIOE de l'opérateur de Calderón plan}
  ...
  \subsection[Expression des opérateurs LD, LR en Fourier]{Expression des opérateurs \(\LD\), \(\LR\) en Fourier}
    ...
    Soient \((x,y,z)\) les coordonnées plan
\begin{REM}
  french ?
\end{REM}
     d'un point de l'espace et un plan d'équation \(z=0\).
...
\end{REM}
\begin{REM}
et donc les coefficients sont définis via la symbole de la CI ?
\end{REM}
    ...
    \begin{REM}
Z chapeau est le symbole de l'opérateur de Calderon ?
\end{REM}
    % \begin{REM}
