\section{Expressions exactes des matrices d'impédance et des matrices de réflexion pour un plan infini}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        Si on fixe \(k_y\) à \(0\) alors \(\hat \mZ\) est une matrice diagonale. Dans la littérature (\cite{stupfel_implementation_2015,aubakirov_electromagnetic_2014,hoppe_impedance_1995}), on nomme les termes diagonaux \(\hat Z_{TM}, \hat Z_{TE}\) tels que
