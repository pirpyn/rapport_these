\section{Expressions exactes des matrices d'impédance et des matrices de réflexions pour un plan infini}
  ...
  \subsection{Expression de la matrice d'impédance pour plusieurs couches}
    ...
    \begin{defn}
      ...
      \begin{align*}
        \mR(k_x,k_y,z,\mZ) &= -\mM_{B}(k_x,k_y,z,\mZ)^{-1}\mM_{A}(k_x,k_y,z,\mZ)
      \end{align*}
    \end{defn}
    A priori, pour \(k_x,k_y,z\) donné, \(\mR(k_x,k_y,z,\mZ)\) n'est pas défini pour toute matrice \(\mZ\).
    ...
    \begin{proof}
      ...
      \begin{equation*}
        ...
        \end{bmatrix}
        =
        \mR(k_x,k_y,z_p^-,\hat\mZ_p(k_x,k_y))
        \begin{bmatrix}
          c_1(k_x,k_y) \\
          c_3(k_x,k_y)
        \end{bmatrix}
      ...
      \begin{multline*}
        ...
        \\
        \left(\mB_{E}(k_x,k_y,z_{p-1})\mR(k_x,k_y,z_p^-,\hat{\mZ}_p(k_x,k_y)) + \mA_{E}(k_x,k_y,z_{p-1})\right)
        \begin{bmatrix}
          c_1(k_x,k_y) \\
          c_3(k_x,k_y)
        \end{bmatrix}
      ...
      \begin{multline*}
        ...
        \\
        \left(\mB_{H}(k_x,k_y,z_{p-1})\mR(k_x,k_y,z_p^-,\hat{\mZ}_p(k_x,k_y)) + \mA_{H}(k_x,k_y,z_{p-1}))\right)
        \begin{bmatrix}
          c_1(k_x,k_y) \\
          c_3(k_x,k_y)
        \end{bmatrix}
      ...
      \begin{multline*}
        \hat{\vE}_t(k_x,k_y,z_{p-1}) =
        \\
        \left(\mA_{E}(k_x,k_y,z_{p-1}) + \mB_{E}(k_x,k_y,z_{p-1})\mR(k_x,k_y,z_p^-,\hat{\mZ}_p(k_x,k_y))\right) \\
        \left(\mA_{H}(k_x,k_y,z_{p-1}) + \mB_{H}(k_x,k_y,z_{p-1})\mR(k_x,k_y,z_p^-,\hat{\mZ}_p(k_x,k_y))\right)^{-1}
        \\
        \vect{e_r}\times\hat{\vH}_t(k_x,k_y,z_{p-1})
      \end{multline*}
...
\subsection{Expression des coefficients de la série de Fourier}
    ...
    \begin{defn}
      ...
      \begin{align*}
        \mN_{E}(k_x,k_y,z,\mZ) &= \mA_{E}(k_x,k_y,z) + \mB_{E}(k_x,k_y,z)\mZ
        \\
        \mN_{H}(k_x,k_y,z,\mZ) &= \mA_{H}(k_x,k_y,z) + \mB_{H}(k_x,k_y,z)\mZ
      \end{align*}
    \end{defn}
    ...
    \begin{prop}%[Théorème de transfert]~
      ...
      alors
      \begin{align*}
        \vE_t(r_{p}^-,k_x,k_y) &= \mN_{E}(k_x,k_y,z_p^-,\mathfrak{T}_p(k_x,k_y,z_p^-,z_p^+,\hat\mR_{p+1}(k_x,k_y)))\vect{C}_{p}(k_x,k_y)
        \\
        \vE_t(r_{p}^-,k_x,k_y) &= \mN_{H}(k_x,k_y,z_p^-,\mathfrak{T}_p(k_x,k_y,z_p^-,z_p^+,\hat\mR_{p+1}(k_x,k_y)))\vect{C}_{p}(k_x,k_y)
      \end{align*}
    \end{prop}
    ...
    \begin{prop}%[Théorème de relévement]~
      ...
      \begin{align*}
        \vE_t(r_{p}^-,k_x,k_y) &= \mN_{E}(k_x,k_y,z_p^-,\hat\mR_{p}(k_x,k_y))\vect{C}_{p}(k_x,k_y)
        \\
        \vect{e_r}\pvect\vH(r_{p}^-,k_x,k_y) &= \mN_{H}(k_x,k_y,z_p^-,\hat\mR_{p}(k_x,k_y))\vect{C}_{p}(k_x,k_y)
      \end{align*}
...
\subsection{Applications numériques}
  ...
  On applique les hypothèses précédentes, donc \(k_y=0\). On remarque que pour \(k_x\slash k_0=2\), \(k_3\) est nul et l'impédance n'est pas définie en ce point. 
