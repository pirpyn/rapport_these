\section[Opérateur de Calderon pour un plan]{Expressions exactes des matrices d'impédance et des matrices de réflexion pour un plan infini}
...
\subsection{Expression des coefficients de la série de Fourier}
    ...
    On peut donc déterminer itérativement les matrices de réflexion.
    \begin{REM}
