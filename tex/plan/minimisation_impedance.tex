\section{Calcul des coefficients de la CI3 par moindres carrés sur l'impédance}
  ...
  \subsection{Résultats numériques sans contraintes}
      ...
      La figure \ref{fig:imp_fourier:plan:triple_asymptote:hoibc} montre la limite de la CI3 pour capturer 3 asymptotes. Pour cela, il faudrait utiliser une CI d'ordre au moins  sur l'opérateur agissant sur \(\vE_t\).
