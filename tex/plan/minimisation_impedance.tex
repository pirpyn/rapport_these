\section{Calcul des coefficients de la CI3 par moindres carrés sur l'impédance}
  ...
  \subsection{Existence et unicité du minimum pour d'autres CIOE}
    ...
    \subsubsection{Existence du minimum pour la CI01}
      ...
      \begin{prop}
        La matrice \({\mM}_{CI01}\) associée à la CI01 est inversible, donc définie, si et seulement s'il existe au moins deux couples \((k_{x},k_{y})\) différents.
      \end{prop}
    ...
    \subsubsection{Existence du minimum pour la CI4}
      ...
      \begin{prop}
        La matrice \({\mM}_{CI4}\) associée à la CI4 est inversible, donc définie, si et seulement s'il existe au moins deux couples \((k_{xi},k_{yi})\) différents.
      \end{prop}
