\section{Calcul des coefficients de la CI3 par moindres carrés sur l'impédance}
  ...
  \subsection[Expression de la fonctionnelle JZ]{Expression de la fonctionnelle \(J_Z\)}
    ...
    \begin{defn}
      ...
      \begin{REM}[fonctionnelle]
        Ce n'est pas une fonctionnelle car ce n'est pas une fonction de fonction. C'est une fonction. A corriger partout
      \end{REM}
      \begin{equation*}
        J_Z(X) = \norm{{\mA}_{CI3}X - {g}}^2.
      \end{equation*}
    ...
    \end{thm}
    \begin{REM}
    Même remarque qu'à \hyperlink{REMminimum}{droite}
    \end{REM}
    \begin{prop}
    ...
    \begin{proof}
      ...
      \end{align*}
      Si la matrice \(\conj{\mA_{CI3}^t}\mA_{CI3}\) est inversible, comme elle est par définition hermitienne et positive, alors la fonctionnelle est quadratique. Il existe donc un unique minimum où le gradient de cette fonctionnelle s'annule. Or
      \begin{align*}
  ...
  \subsection{Existence et unicité du minimum pour d'autres CIOE}
    ...
    \end{prop}
    \begin{REM}
      Est-ce que \(\mH\) est la même chose que \(\mA\) ?
    \end{REM}
    \begin{REP}
      Oui. Je dois corriger ça.
    \end{REP}
    \begin{proof}
      On remarque que la fonctionnelle \(F\)
      \begin{REM}
        Que vaut F ici ? JZ ?
      \end{REM}
      est quadratique si la matrice \(\conj{\mH^t}{\mH}\) est hermitienne définie positive. Une matrice \(\mA\) est hermitienne si \(\forall x, \conj{x^t}\mA x \in \RR\), elle est hermitienne positive si \(\forall x, \conj{x^t}\mA x \in \RR^+\) et elle est hermitienne définie positive si \(\forall x\not=0, \conj{x^t}\mA x \in \RR^{+*}\).
    ...
    \begin{prop}
      ...
      \begin{REM}
        mal dit. Si M est définie, l'unique minimum vaut
      \end{REM}
      \[
    ...
    \subsubsection{Existence du minimum pour la CI01}
      ...
      \begin{prop}
        ...
        \begin{REM}[matM]
          Mauvaise matrice
        \end{REM}
        associée à la CI01 est inversible, donc définie, si et seulement s'il existe au moins deux couples \((k_{x},k_{y})\) différents.
      \end{prop}
    ...
    \subsubsection{Existence du minimum pour la CI4}
      ...
      \begin{prop}
        ...
        \begin{REM}[matM]
          Mauvaise matrice
        \end{REM}
        associée à la CI4 est inversible, donc définie, si et seulement s'il existe au moins deux couples \((k_{xi},k_{yi})\) différents.
      \end{prop}
      ...
      \begin{REM}
        De quoi ceci est la démo ?
      \end{REM}
      \begin{REP}
        les même prop que précédent avec CI1
      \end{REP}
        ...
        Pour prouver son inversibilité, on exprime son déterminant 
        \begin{multline*}
          \det( {\mM}_{CI1}) = \ps{t^2}{z}\det({\mM}_{CI01}) + 4 \ps{t}{1}\Re\left(\ps{t^2}{s}\ps{t^2}{\conj{s}}\right)
          \\
