\section{Approximation de l'opérateur d'impédance pour un plan infini par une condition d'impédance d'ordre élevée}
  ...
  \subsection{Résultats numériques}
      ...
      \begin{table}[!hbt]
        ...
        \begin{coefftable}{\hyperlink{ci0}{CI0}}
          \input{csv/HOPPE_33/HOPPE_33.IBC_ibc0_SUC_F_MODE_2_TYPE_P.coeff.txt}
          \\
          \\
          \\
          \\
        ...
        \begin{coefftable}{\hyperlink{ci3}{CI3}}
          \input{csv/HOPPE_33/HOPPE_33.IBC_ibc3_SUC_F_MODE_2_TYPE_P.coeff.txt}
        \end{coefftable}
      ...
      \begin{table}[!hbt]
        ...
        % On fait deux tables de même hauteur
        \begin{coefftable}{\hyperlink{ci0}{CI0}}
          \input{csv/SOUDAIS/SOUDAIS.IBC_ibc0_SUC_F_MODE_2_TYPE_P.coeff.txt}
          \\
          \\
          \\
          \\
        \end{coefftable}
        \begin{coefftable}{\hyperlink{ci3}{CI3}}
          \input{csv/SOUDAIS/SOUDAIS.IBC_ibc3_SUC_F_MODE_2_TYPE_P.coeff.txt}
        \end{coefftable}
      ...
      \begin{table}[!hbt]
        ...
        \begin{coefftable}{\hyperlink{ci7}{CI7}}
          \input{csv/triple_asymptote/triple_asymptote.IBC_ibc7_SUC_F_MODE_2_TYPE_P.coeff.txt}
        \end{coefftable}
        \end{minipage}
  ...
  \subsection{Lien avec les CIOE de \cite{stupfel_implementation_2015}}
    ...
    \begin{table}[!hbt]
      ...
      % On fait deux tables de même hauteur
      \begin{coefftable}{\hyperlink{ci0}{CI0}}
        \input{csv/STUPFEL/STUPFEL.IBC_ibc0_SUC_F_MODE_2_TYPE_P.coeff.txt}
        \\
        \\
      \end{coefftable}
      \begin{coefftable}{\hyperlink{ci01}{CI01}}
        \input{csv/STUPFEL/STUPFEL.IBC_ibc01_SUC_F_MODE_2_TYPE_P.coeff.txt}
      \end{coefftable}

      \begin{coefftable}{\hyperlink{ci1}{CI1}}
        \input{csv/STUPFEL/STUPFEL.IBC_ibc1_SUC_F_MODE_2_TYPE_P.coeff.txt}
        \\
        \\
        \\
      \end{coefftable}
      \begin{coefftable}{\hyperlink{ci3}{CI3}}
        \input{csv/STUPFEL/STUPFEL.IBC_ibc3_SUC_F_MODE_2_TYPE_P.coeff.txt}
      \end{coefftable}
