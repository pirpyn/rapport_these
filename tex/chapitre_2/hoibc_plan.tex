\section{Approximation de l'opérateur d'impédance pour un plan infini par une condition d'impédance d'ordre élevée}
  ...
  \subsection{Résultats numériques}
      ...
      \begin{table}[!hbt]
        ...
        a_0 & \p \expnumber{3.44448575}{-19} + \expnumber{3.63587819}{-01} i \\
        a_1 & - \expnumber{2.04163909}{-19} + \expnumber{9.08682239}{-02} i \\
        a_2 & - \expnumber{5.11740528}{-18} - \expnumber{2.39638482}{-03} i \\
        b_1 & - \expnumber{3.98932004}{-02} + \expnumber{3.56714245}{-18} i \\
        b_2 & - \expnumber{4.67621921}{-02} + \expnumber{1.60716133}{-17} i
        \end{coefftable}
      ...
      \begin{table}[!hbt]
        ...
        \end{coefftable}
        \begin{coefftable}{\hyperlink{ci3}{CI3}}
          a_0 &  \expnumber{1.38256759}{-17} - \expnumber{2.64478990}{+00} i \\
          a_1 &  \expnumber{4.50412629}{-18} - \expnumber{6.04970732}{-01} i \\
          a_2 &  \expnumber{5.48404922}{-18} + \expnumber{1.96123573}{-01} i \\
          b_1 &  \expnumber{1.22604389}{+00} - \expnumber{6.60566701}{-18} i \\
          b_2 &  \expnumber{1.22603617}{+00} + \expnumber{5.80696760}{-19} i
        \end{coefftable}
      ...
      \begin{table}[!hbt]
        ...
        \vspace{0pt}
        \begin{coefftable}{\hyperlink{ci0}{CI0}}
          a_0 &  {\color{white}\expnumber{0.00000000}{+00}} - \expnumber{8.54541280}{-01} i
        \end{coefftable}

        \begin{coefftable}{\hyperlink{ci3}{CI3}}
          a_0 &  \expnumber{4.19892624}{-20} - \expnumber{7.96599991}{-01} i \\
          a_1 &  \expnumber{2.14386510}{-19} - \expnumber{4.46188293}{-01} i \\
          a_2 &  \expnumber{7.66725614}{-20} - \expnumber{3.04836847}{-01} i \\
          b_1 &  \expnumber{6.47295075}{-01} + \expnumber{4.98521380}{-19} i \\
          b_2 &  \expnumber{3.82519846}{-01} + \expnumber{6.86081303}{-20} i 
        \end{coefftable}
        \end{minipage}
        \begin{minipage}[t]{0.5\textwidth}
        \vspace{0pt}
        \begin{coefftable}{\hyperlink{ci7}{CI7}}
        a_0 & - \expnumber{1.23885135}{-17} - \expnumber{8.80790363}{-01} i \\
        b_1 & - \expnumber{6.12763156}{-17} - \expnumber{6.81085409}{-01} i \\
        b_2 & - \expnumber{4.41564998}{-17} - \expnumber{1.09339848}{-01} i \\
        b_3 & - \expnumber{7.71223956}{-18} + \expnumber{3.24374873}{-03} i \\
        c_1 & - \expnumber{5.90089820}{-17} - \expnumber{2.92065101}{-01} i \\
        c_2 & - \expnumber{4.53338720}{-17} + \expnumber{2.47101839}{-01} i \\
        c_3 & - \expnumber{8.59813966}{-18} + \expnumber{7.46498669}{-02} i \\
        d_1 & \p \expnumber{2.66875709}{+00} + \expnumber{3.48610891}{-17} i \\
        d_2 & \p \expnumber{1.37173269}{+00} + \expnumber{9.06961874}{-18} i \\
        d_3 & \p \expnumber{1.93680561}{-01} - \expnumber{7.26133113}{-19} i \\
        e_1 & \p \expnumber{2.66857107}{+00} + \expnumber{2.26399180}{-17} i \\
        e_1 & \p \expnumber{2.66857107}{+00} + \expnumber{2.26399180}{-17} i \\
        e_3 & \p \expnumber{1.93557446}{-01} + \expnumber{2.62810674}{-18} i
        \end{coefftable}
        \end{minipage}
  ...
  \subsection{Lien avec les CIOE de \cite{stupfel_implementation_2015}}
    ...
    \begin{figure}[!hbt]
      \centering
      \input{tikz/plot/Z_cioe_2015_plan_hoibc.tikz}
    ...
    \begin{figure}[!hbt]
      \centering
      \input{tikz/plot/R_cioe_2015_plan_hoibc.tikz}
