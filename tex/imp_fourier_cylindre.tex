\section{Cas d'un objet cylindrique}
  ...
  \begin{TODO}
    Corriger erreur de signe dans le Z
  \end{TODO}
    ...
    \begin{figure}[!hbt]
      ...
      \begin{tikzpicture}[scale=1]
        \begin{axis}[
          ...
          \legend{TM,TE}
          \addplot [black] table [x={s}, y={imag(z.tm)},col sep=semicolon] {tikz/csv/impedance/cylindre/hoppe_p62_1_r.csv};
          \addplot [black,dashed] table [x={s}, y={imag(z.te)},col sep=semicolon] {tikz/csv/impedance/cylindre/hoppe_p62_1_r.csv};
        \end{axis}
      \end{tikzpicture}
    ...
    \begin{figure}[!hbt]
      ...
      \begin{tikzpicture}[scale=1]
        \begin{axis}[
          ...
          % \addlegendentry{TM plan}
          % \addplot table [col sep=semicolon, x={s}, y={imag(z.te)}] {tikz/csv/impedance/plan/hoppe_p62.csv};
          % \addlegendentry{TE plan}
          \addplot [black] table [col sep=semicolon, x={s}, y={imag(z.tm)}] {tikz/csv/impedance/cylindre/hoppe_p62_1_r.csv};
          \addlegendentry{TM \(r_0=r_i\)}
          \addplot [black,dashed] table [col sep=semicolon, x={s}, y={imag(z.te)}] {tikz/csv/impedance/cylindre/hoppe_p62_1_r.csv};
          \addlegendentry{TE \(r_0=r_i\)}
          \addplot [black,mark=*] table [col sep=semicolon, x={s}, y={imag(z.tm)}] {tikz/csv/impedance/cylindre/hoppe_p62_100_r.csv};
          \addlegendentry{TM \(r_0=100r_i\)}
          \addplot [black,dashed,mark=*] table [col sep=semicolon, x={s}, y={imag(z.te)}] {tikz/csv/impedance/cylindre/hoppe_p62_100_r.csv};
          \addlegendentry{TE \(r_0=100r_i\)}
        \end{axis}
      \end{tikzpicture}
