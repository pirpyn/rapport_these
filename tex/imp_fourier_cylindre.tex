        ...
        \begin{figure}[!hbt]
            ...
            \begin{tikzpicture}[scale=1]
                \begin{axis}[
                    ...
                    \legend{TM,TE}
                    \addplot [blue,thick,mark=*] table [x={s}, y={imag(z.tm)},col sep=semicolon] {tikz/csv/impedance_cylindre_1_couche_hoppe_p62.csv};
                    \addplot [red,thick,mark=x] table [x={s}, y={imag(z.te)},col sep=semicolon] {tikz/csv/impedance_cylindre_1_couche_hoppe_p62.csv};
                \end{axis}
            \end{tikzpicture}
        ...
        \begin{figure}[!hbt]
            ...
            \begin{tikzpicture}[scale=1]
                \begin{axis}[
                    ...
                    \addplot [blue,thick,mark=*] table [col sep=semicolon, x={s}, y={imag(z.tm)}] {tikz/csv/impedance_1_couche_hoppe_p62_plan.csv};
                    \addplot [red,thick,mark=x]  table [col sep=semicolon, x={s}, y={imag(z.te)}] {tikz/csv/impedance_1_couche_hoppe_p62_plan.csv};
                    \addplot [cyan,thick,mark=*,dashed] table [col sep=semicolon, x={s}, y={imag(z.tm)}] {tikz/csv/impedance_1_couche_hoppe_p62_1_r_cylindre.csv};
                    \addplot [magenta,thick,mark=x,dashed]  table [col sep=semicolon, x={s}, y={imag(z.te)}] {tikz/csv/impedance_1_couche_hoppe_p62_1_r_cylindre.csv};
                    \addplot [violet,thick,mark=*,dotted] table [col sep=semicolon, x={s}, y={imag(z.tm)}] {tikz/csv/impedance_1_couche_hoppe_p62_100_r_cylindre.csv};
                    \addplot [purple,thick,mark=x,dotted]  table [col sep=semicolon, x={s}, y={imag(z.te)}] {tikz/csv/impedance_1_couche_hoppe_p62_100_r_cylindre.csv};
