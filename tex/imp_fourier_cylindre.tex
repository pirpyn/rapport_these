    ...
    \begin{figure}[!hbt]
      ...
      \begin{tikzpicture}[scale=1]
        \begin{loglogaxis}[
          ...
          \legend{TM,TE}
          \addplot table [x={r0/d}, y={tm},col sep=semicolon] {tikz/csv/impedance/cylindre/hoppe_p62_error.csv};
          \addplot table [x={r0/d}, y={te},col sep=semicolon] {tikz/csv/impedance/cylindre/hoppe_p62_error.csv};
        \end{loglogaxis}
      \end{tikzpicture}
