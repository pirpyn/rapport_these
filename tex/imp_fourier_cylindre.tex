\section{Cas d'un objet cylindrique}
    ...
    \TODO{Numériquement, le choix des fonctions de Bessels, importe peu pour $\mZ$. L'expliquer}
    \begin{equation}
        ...
        \begin{figure}[!hbt]
            ...
            \begin{tikzpicture}[scale=1]
                \begin{axis}[
                    ...
                    \legend{TM,TE}
                    \addplot [black,thick,mark=x] table [x={s}, y={imag(z.tm)}] {\hoppeimpcylindre};
                    \addplot [black,thick,mark=*] table [x={s}, y={imag(z.te)}] {\hoppeimpcylindre};
                \end{axis}
            \end{tikzpicture}
