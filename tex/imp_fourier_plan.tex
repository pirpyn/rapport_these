        ...
        \begin{figure}[!hbt]
            ...
            \begin{tikzpicture}[scale=1]
                \begin{axis}[
                    ...
                    \addplot [blue,thick,mark=*] table [x={s}, y={imag(z.tm)},col sep=semicolon] {tikz/csv/impedance_plan_1_couche_soudais.csv};
                    \addplot [red,thick,mark=x] table [x={s}, y={imag(z.te)},col sep=semicolon] {tikz/csv/impedance_plan_1_couche_soudais.csv};
                \end{axis}
            \end{tikzpicture}
            \begin{tikzpicture}[scale=1]
                \begin{axis}[
                    ...
                    \legend{TM,TE}
                    \addplot [blue,thick,mark=*] table [x={s}, y={imag(z.tm)},col sep=semicolon] {tikz/csv/impedance_plan_1_couche_soudais_agrandis.csv};
                    \addplot [red,thick,mark=x] table [x={s}, y={imag(z.te)},col sep=semicolon] {tikz/csv/impedance_plan_1_couche_soudais_agrandis.csv};
                \end{axis}
            \end{tikzpicture}
