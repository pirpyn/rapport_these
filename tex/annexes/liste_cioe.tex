...
\hline
\hline
\hypertarget{ci6}{CI6} & Curvature ratio & \left(\oI + c_1 \frac{\LD}{k_0^2} - c_2 \frac{\LR}{k_0^2} \right)\vE_t = \left(\diag{a_1}{a_2} + b_1 \frac{\LD}{k_0^2} - b_2 \frac{\LR}{k_0^2} \right)\vJ & \cite{hoppe_impedance_1995}
\\
\hline
\hline
