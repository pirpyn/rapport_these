\section{CSU pour les CIOE de \cite{stupfel_sufficient_2011}}
  ...
  La plupart des résultats de cette section ont déjà été montrés dans \cite{stupfel_sufficient_2011}. Nous les rappelons néanmoins car peux de résultats existent sur l'existence de CSU pour les CIOE. 

  Commençons par rappeler l'expression et les propriétés du l'opérateur de Hodge \(\mathcal{L}\)
  ...
  \begin{prop}
    L’opérateur \(\LL\) est antisymétrique négatif: pour tous \(\vu,\vv \in (\mathcal C^\infty(\CC,\Gamma))^3\)
    \begin{align}
  ...
  De plus, dans la suite, pour alléger les expressions, on note \(\int_\Gamma \vJ \cdot \conj{\vE_t} ds(\vx)\) par \(X\). On rappelle que la l'on veut trouver des conditions permettant de garantir \eqref{eq:unicite:form_var:cgu} qui est \(\Re(X)\ge0\).
  ...
  \subsection{CSU de la CI0}
    ...
    Dans le cadre de l'approximation plan infini, cette CSU est toujours vérifiée pour une couche par hypothèse sur les matériaux.
    Cependant cette propriété n'est pas garantie pour plusieurs couches ou dans le cadre des autres approximations.
