\section{CSU pour les CIOE de \cite{stupfel_sufficient_2011}}
  ...
  De plus, dans la suite, pour alléger les expressions, on note
  \begin{equation}
    X = \int_\Gamma \vJ \cdot \conj{\vE_t} ds(\vx)
  \end{equation}
  On rappelle que la l'on veut trouver des conditions permettant de garantir \eqref{eq:unicite:form_var:cgu} qui est \(\Re(X)\ge0\).
