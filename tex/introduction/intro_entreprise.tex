...
Une CIOE similaire (eq.~(22), p.~432 s'exprimant entre \((\vn\pvect\vE)_t\) et \(\vH_t\) et non \(\vE_t\) et \((\vn \pvect \vH)_t\)) mais plus performante a été proposée dans \cite{marceaux_high-order_2000} et reprise dans \cite{aubakirov_electromagnetic_2014} (eq.~(3.13), p.~21, avec les mêmes conventions que cette thèse) et \cite{soudais_3d_2017}.
