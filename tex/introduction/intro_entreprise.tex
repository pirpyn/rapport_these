...
La plus connue consiste à remplacer l'empilement de matériaux
\begin{REM}
	l'empilement: ajouter de matériaux
\end{REM}
 par une \gls{acr-ci} écrite sur sa 
 \begin{REM}
	supprimer sa
\end{REM}
la surface extérieure de l'objet: cette CI, implémentée dans une \gls{acr-ei}, permet de s’affranchir de la résolution des équations de Maxwell dans les matériaux.
