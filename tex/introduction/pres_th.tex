...
La finalité de cette thèse est de proposer un modèle permettant de remplacer un empilement de matériaux par une condition aux limites implémentée dans un code équations intégrales, afin de ne pas mailler l'intérieur de l'objet.

Cette condition aux limites fera parti d'une famille  connu de conditions aux limites, les conditions d'impédances ( \cite{senior_approximate_1995} ) qui sont paramétrées par des coefficients complexes.
