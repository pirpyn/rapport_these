      ...
      \begin{figure}[!hbt]
          ...
          \begin{tikzpicture}[scale=1]
              \begin{axis}[
                  ...
                  \addplot+ [color=black] table [col sep=semicolon, x={s1}, y={Im(z_ex.tm)}] {tikz/csv/impedance/plan/HOPPE_33.z_ex.P.csv};
                  % \addlegendentry{Exact};

                  \addplot+ [color=blue] table [col sep=semicolon, x={s1}, y={Im(z_ibc0.tm)}] {tikz/csv/impedance/plan/HOPPE_33.z_ci.IBC_ibc0_TYPE_P_SUC_F.csv};
                  % \addlegendentry{IBC0};

                  \addplot+ [color=red] table [col sep=semicolon, x={s1}, y={Im(z_ibc3.tm)}] {tikz/csv/impedance/plan/HOPPE_33.z_ci.IBC_ibc3_TYPE_P_SUC_F.csv};
                  % \addlegendentry{IBC3};                  
              \end{axis}
          \end{tikzpicture}
          \begin{tikzpicture}[scale=1]
              \begin{axis}[
                  ...
                  \addplot+ [color=black] table [col sep=semicolon, x={s1}, y={Im(z_ex.te)}] {tikz/csv/impedance/plan/HOPPE_33.z_ex.P.csv};
                  \addlegendentry{Exact};

                  \addplot+ [color=blue] table [col sep=semicolon, x={s1}, y={Im(z_ibc0.te)},color=] {tikz/csv/impedance/plan/HOPPE_33.z_ci.IBC_ibc0_TYPE_P_SUC_F.csv};
                  \addlegendentry{IBC0};

                  \addplot+ [color=red] table [col sep=semicolon, x={s1}, y={Im(z_ibc3.te)}] {tikz/csv/impedance/plan/HOPPE_33.z_ci.IBC_ibc3_TYPE_P_SUC_F.csv};
                  \addlegendentry{IBC3};                  
              \end{axis}
          \end{tikzpicture}
      ...
      \begin{figure}[!hbt]
          ...
          \begin{tikzpicture}[scale=1]
              \begin{axis}[
                  ...
                  \addplot+ [color=black] table [col sep=semicolon, x={s1}, y={Im(z_ex.tm)}] {tikz/csv/impedance/plan/ICEAA_11.z_ex.P.csv};
                  % \addlegendentry{Exact};

                  \addplot+ [color=blue] table [col sep=semicolon, x={s1}, y={Im(z_ibc0.tm)}] {tikz/csv/impedance/plan/ICEAA_11.z_ci.IBC_ibc0_TYPE_P_SUC_F.csv};
                  % \addlegendentry{IBC0};

                  \addplot+ [color=red] table [col sep=semicolon, x={s1}, y={Im(z_ibc3.tm)}] {tikz/csv/impedance/plan/ICEAA_11.z_ci.IBC_ibc3_TYPE_P_SUC_F.csv};
                  % \addlegendentry{IBC3};                  
              \end{axis}
          \end{tikzpicture}
          \begin{tikzpicture}[scale=1]
              \begin{axis}[
                  ...
                  \addplot+ [color=black] table [col sep=semicolon, x={s1}, y={Im(z_ex.te)}] {tikz/csv/impedance/plan/ICEAA_11.z_ex.P.csv};
                  \addlegendentry{Exact};

                  \addplot+ [color=blue] table [col sep=semicolon, x={s1}, y={Im(z_ibc0.te)},color=] {tikz/csv/impedance/plan/ICEAA_11.z_ci.IBC_ibc0_TYPE_P_SUC_F.csv};
                  \addlegendentry{IBC0};

                  \addplot+ [color=red] table [col sep=semicolon, x={s1}, y={Im(z_ibc3.te)}] {tikz/csv/impedance/plan/ICEAA_11.z_ci.IBC_ibc3_TYPE_P_SUC_F.csv};
                  \addlegendentry{IBC3};                  
              \end{axis}
          \end{tikzpicture}
