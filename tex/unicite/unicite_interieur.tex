\section[Une CNS pour l'unicité des solutions du problème de Maxwell intérieur]{Une condition nécessaire et suffisante pour l'unicité des solutions du problème de Maxwell intérieur}
...
\end{REM}
    ...
    \begin{proof}
      ...
      \begin{REM}
  remarque
\end{REM} que toutes les composantes du champs \(\vE\) ( idem pour \(\vH\) ) sont solutions de \(\ddr[2]{u}{z} + (k_i^2 - ( k_x^2 + k_y^2 ) ) u = 0 \), dont les solutions sont données par la famille \((\sin(\kk_i z),\cos(\kk_i z))\) selon la couche.
