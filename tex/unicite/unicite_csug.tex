\section[Une CSU des solutions du problème de Maxwell extérieur]{Une condition suffisante assurant l'unicité des solutions du problème de Maxwell extérieur}
  ...
  Puisque le problème est sans sources, nous allons déterminer une condition suffisante qui assure que seuls les champs nuls sont solutions de ce problème.
  ...
  Quand il est bien posé, le problème \eqref{eq:unicite:maxwell_ext_2} sans sources muni de la condition \eqref{eq:unicite:TR} est équivalent à
  % \begin{REM}
