\section[Une CSU des solutions du problème de Maxwell extérieur]{Une condition suffisante assurant l'unicité des solutions du problème de Maxwell extérieur}
  ...
  On s’intéresse à la propagation des ondes électromagnétiques à l'extérieur d'un objet fermé borné, sans sources. Les champs associés sont solutions des équations de Maxwell harmoniques \(e^{i\w t}\). Cependant dans cette thèse, nous utilisons une forme non usuelle des équations de Maxwell et nous renvoyons à l'annexe \ref{sec:annex:maxwell_equation}.
