\section[Des CSU pour la CIOE de Aubakirov 2014]{Des conditions suffisantes pour la CIOE de \cite{aubakirov_electromagnetic_2014}}
...
\subsection{CSU pour la CI3}
 ...
 \begin{prop}[Une première CSU pour la CI3]
  ...
  Soit \(S = \left\lbrace (a_0,a_1,a_2,b_1,b_2) \in \CC^5 ; a_1 = a_2 ; b_1 = b_2 \right\rbrace \). On remarque que
  \begin{align}
 ...
 \begin{prop}[Une deuxième CSU pour la CI3]
  ...
  \end{align}
    ...
    \begin{equation}
      \label{eq:unicite:z}
      \begin{matrix}
        z: & \CC\times\CC^*\times\CC^*\times \CC \times \CC &\rightarrow& \CC
        \\
        & (a_0,a_1,a_2,b_1,b_2) & \mapsto & 1 - \frac{b_1a_0}{a_1} - \frac{b_2a_0}{a_2}
      \end{matrix}
    \end{equation}
