...
\subsection{CSU 2018 de Lafitte-Stupfel}
  ...
  \begin{proof}
    ...
    \begin{align}
      X &= \int_\Gamma \left(a_0 + a_1 \LD - a_2 \LR \right)^{-1}\left( + b_1 \LD - b_2 \LR \right) \vE_t\cdot \conj{\vE_t}
    \end{align}
    ...
    \begin{align}
      \vD & = \left(a_0  + a_1 \LD - a_2\LR \right)^{-1} \vE_t
      \\
      \vF_1 & = \left( - a_2 \left( a_0 + a_1\LD\right)^{-1}\LR\right)^{-1} \vE_t
      \\
      \vF_2 & = \left( + a_1 \left( a_0 - a_2\LR\right)^{-1}\LD\right)^{-1} \vE_t
    \end{align}

    Alors immédiatement, on a

    \begin{multline}
      X = \int_\Gamma z \vD \cdot \left(\conj{a_0}  + \conj{a_1} \LD - \conj{a_2}\LR\right)\conj{\vD}
      \\
      + \frac{b_1}{a_1} \left( - \conj{a_2} \left( \conj{a_0} + \conj{a_1}\LD\right)^{-1}\LR\right)\conj{\vF_1}\cdot\vF_1
      \\
      + \frac{b_2}{a_2} \left( + \conj{a_1} \left( \conj{a_0} - \conj{a_2}\LR\right)^{-1}\LD\right)\conj{\vF_2}\cdot\vF_2
    \end{multline}
    ...
    \begin{align}
      \vG_1 & = \left(\conj{a_0}  + \conj{a_1} \LD \right)^{-1}\LR \conj{\vF_1}
      \\
      \vG_2 & = \left(\conj{a_0}  - \conj{a_2} \LR \right)^{-1}\LD \conj{\vF_2}
    \end{align}
    ...
    \begin{align}
      \LD\LR\conj{\vF_1} &= \LD\left(\conj{a_0}  + \conj{a_1} \LD \right)\vG_1
      \\
      0 & =\left(\conj{a_0}  + \conj{a_1} \LD \right)\LD\vG_1
    \end{align}

    Si l'on suppose alors que \(\Re(a_0) \ge 0 \) et \(\Re(a_1) \le 0\) (resp. \(\Re(a_2)\le0\)), alors \(\left(\conj{a_0}  + \conj{a_1} \LD \right)\) (resp. \(\left(\conj{a_0}  - \conj{a_2} \LR \right)\)) est injectif et donc on déduit que
  ...
  % \end{TODO}
    ...
    Or par définition \(\LR\conj{\vF_1} = \left(\conj{a_0}  + \conj{a_1} \LD \right)\vG_1\) (resp. \(\LR\conj{\vF_2} = \left(\conj{a_0}  - \conj{a_2} \LR \right)\vG_2\)) donc
    \begin{align}
