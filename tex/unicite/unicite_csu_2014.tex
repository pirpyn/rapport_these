...
\subsection{CSU pour la CI3}
 ...
 \begin{prop}[Une première CSU pour la CI3]
  ...
  \begin{proof}
    ...
    De la condition aux limites sur \(\Gamma\), on déduit par produit scalaire \(L^2\) avec un certain nombre de vecteurs bien choisis, des égalités qui sont nécessairement vérifiées.
