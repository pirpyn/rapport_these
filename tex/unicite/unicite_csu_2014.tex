\section[Des CSU pour la CIOE de Aubakirov 2014]{Des conditions suffisante pour la CIOE de \cite{aubakirov_electromagnetic_2014}}

  Dans la thèse de Abil \cite{aubakirov_electromagnetic_2014}, l'opérateur de Hodge \gls{ope-L} est séparé en deux.

  \begin{defn}
    Les opérateurs \gls{ope-LD} et \gls{ope-LR} sont définis tels que %sont introduits par \cite[eq.~4]{stupfel_implementation_2015} et s'expriment pour tous vecteurs complexes régulier tangents à \(\Gamma\) 

    Pour tous \(\vect U,\vect V \in (\mathcal{C}^\infty(\Gamma))\): 
    \begin{align*}
  ...
  \begin{prop}
    ...
    Pour tous \(\vect U \in (\mathcal{C}^\infty(\Gamma))\): 
    \begin{align*}
      \int_\Gamma \LD(\vect U)\cdot \conj{\vect U} &= -\int_\Gamma |\tdivs \vect U|^2
      \\
      \int_\Gamma \LR(\vect U)\cdot \conj{\vect U} &= \int_\Gamma |\vn \cdot \tvrots \vect U|^2
    \end{align*}
  \end{prop}
...
\subsection{CSU pour la CI4}
  ...
  On remarque que si \(a_1=a_2\), ces CSU sont identiques aux CSU-01.
...
\subsubsection{1\iere méthode}
  ...
  Pour conclure, on remarque que l'on obtient 3 groupes de CSU
  \begin{itemize}
