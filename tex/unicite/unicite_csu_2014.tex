...
\subsection{CSU pour la CI3}
 ...
 \begin{prop}[Une première CSU pour la CI3]
  ...
  \begin{proof}
    ...
    On utilise l'identité \(\int_\Gamma \conj{\LL_3(\vE_t,\vJ)}\cdot \vJ = 0\) qui découle de la CI3, et dont on déduit
    \begin{multline}
    ...
    \end{multline}
    On utilise \(\int_\Gamma \conj{\LL_3(\vE_t,\vJ)}\cdot\LR\vJ = 0\)
    \begin{equation}
    ...
    \end{equation}
    On utilise \(\int_\Gamma {\LL_3(\vE_t,\vJ)}\cdot\LR\conj{\vE_t}=0\)
    \begin{equation}
    ...
    \end{equation}
    On utilise \(\int_\Gamma \conj{\LL_3(\vE_t,\vJ)}\cdot\LD\vJ=0\)
    \begin{equation}
    ...
    \end{equation}
    On utilise \(\int_\Gamma {\LL_3(\vE_t,\vJ)}\cdot\LD\conj{\vE_t}=0\)
    \begin{equation}
   ...
   \eqref{eq:unicite:ci3:csu3r-rj2} \& \eqref{eq:unicite:ci3:csu3r-re2} et \eqref{eq:unicite:ci3:csu3d-dj2} \& \eqref{eq:unicite:ci3:csu3d-de2} impliquent
    ...
    \end{equation}
    Pour conclure, on remarque que l'on déduit 3 CSU
    \begin{itemize}
