...
\section{Etude de l'unicité des solutions du problème extérieur avec CIOE sur le bord}
  ...
  {~}\\{~}
  Tout le problème est de choisir les paramètres complexes des CIOE, obtenus grâce à des approximations issues de critères physiques (matériaux, courbure et fréquence) mais % @Olivier Décommente les ~1240 prochaines lignes, puis les 4 dernieres
% La balise @Olivier t'aidera
...
\section{Etude de l'unicité des solutions du problème extérieur avec CIOE sur le bord}
  ...
  {~}\\{~}
  Tout le problème est de choisir les paramètres complexes des CIOE, obtenus grâce à des approximations issues de critères physiques (matériaux, courbure et fréquence) mais ne dépendant pas de la solution du problème diffracté calculée avec l'opérateur de Calderòn. 

  Il apparait donc comme incorrrect de considerer des paramètres qui ne permettraient pas d'obtenir une unique solution.
...
% @Olivier: Décommente les lignes ci dessous: c'est bon...
...
. 
  ...
  S'il n'y a pas unicité, par l'alternative de Fredholm, pour un problème avec source, on peut ne pas avoir existence.
  Dans le cas d'une source nulle, l'existence est assurée puisque la solution nulle vérifie toutes les conditions et équations du problème.
