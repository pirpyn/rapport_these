...
\section{Equations de Maxwell à l'intérieur et à l'extérieur de l'objet}
    ...
    \subsection{Etude de l'unicité des solutions du problème intérieur}
        ...
        \begin{thm}
            ...
            Si \(\w^2\eps\mu\) est une valeur propre du Laplacien vectoriel, \eqref{eq:unicite:maxwell_int} avec conditions aux limites de Dirichlet \(\vE_{|\Gamma} = 0\), \(\vE_{|\Gamma_0} = 0\) a pour solution tous les vecteurs propres de  l'opérateur \(A\) introduit par \cite[eq.~(133), p.~58]{cessenat_mathematical_1996}.
        \end{thm}
