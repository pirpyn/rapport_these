...
% % pdflatex -shell-escape -file-line-error -interaction=nonstopmode --synctex=1 --output-directory=build chapitre_05
...
\section{Equations de Maxwell à l'extérieur de l'objet avec une approximation de l'opérateur de Calderon sur son bord}
    ...
    \subsection{Approximation constante de l'operateur de Calderon: la condition de Leontovich}
        ...
        \begin{REM}
            Référence de cette affirmation. Probablement M. A. Leontovich, On a method of solving the problem of propagation of electromagnetic
waves near the surface of the earth, Isvestia Akad. Nauk. SSSR, Ser. Phys., 8 (1944),
pp. 16-22.
        \end{REM}

        \begin{REM}
            Et je crois pour des matériaux fort indice (\(kd>>\lambda\) ? ). A vérifier dans tes formules. Sinon, tu peux cite Senior formules (30-33) (je te le mets en retour).
