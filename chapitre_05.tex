            ...
            \subsubsection{Expression de l'opérateur de Calderon pour \(k_z\) quelconque}
              ...
              \begin{align*}
                \begin{split}
                  ...
                  \\
                  {}& + i\eta\frac{n^2k_z^2}{kk_3r_1^2}\Tni,
                \end{split}
                \\
                \hat\mZ_n(k_z)_{12} ={}& -i\eta\frac{nk_z}{kk_3r_1\eta}\Tni,
                \\
                \hat\mZ_n(k_z)_{21} ={}& -i\eta\frac{nk_z}{kk_3r_1\eta}\Tni,
                \\
                \hat\mZ_n(k_z)_{11} ={}& i\eta\frac{k_3}{k}\Tni.
              \end{align*}
