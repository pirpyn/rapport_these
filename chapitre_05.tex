...
\section{Equations de Maxwell à l'extérieur avec condition limite de Calderon}
    ...
    \subsection{Expression de l'opérateur de Calderon pour un cylindre infini}
        ...
        % \begin{REM}
        %     Vérif calcul matriciel qui suit
        % \end{REM}
        ...
        % \end{align*}
        % \begin{align*}
        % \mH_{E}(r_0,n,k_z)^{-1} &= -\frac{k_3}{ik\eta}\frac{1}{H_n^{[2]}{}'(k_3r_0)H_n^{[2]}(k_3r_0)}
        %     \begin{bmatrix}
        %         0 & -\frac{ik\eta}{k_3}H_n^{[2]}{}'(k_3r_0)
        %         \\
        %         -H_n^{[2]}(k_3r_0) & -\frac{nk_z}{r_0k_3^2}H_n^{[2]}(k_3r_0)
        %     \end{bmatrix},
        %     \\
        %     &= 
        %     \begin{bmatrix}
        %         0 & \frac{1}{H_n^{[2]}{}(k_3r_0)}
        %         \\
        %         \frac{k_3}{ik\eta}\frac{1}{H_n^{[2]}{}'(k_3r_0)} & \frac{nk_z}{r_0k_3ik\eta}\frac{1}{H_n^{[2]}{}'(k_3r_0)}
        %     \end{bmatrix},
        % \end{align*}

        % \begin{align*}
        % \mH_{E}(r_1,n,k_z)\mH_{E}(r_0,n,k_z)^{-1} &=
        %     \\
        %     &\begin{bmatrix}
        %         -\frac{nk_z}{r_1k_3^2}H_n^{[2]}(k_3r_1) & \frac{ik\eta}{k_3}H_n^{[2]}{}'(k_3r_1)
        %         \\
        %         H_n^{[2]}(k_3r_1) & 0
        %     \end{bmatrix}
        %     \begin{bmatrix}
        ...
        %     &=
        %     \begin{bmatrix}
        %         \frac{H_n^{[2]}{}'(k_3r_0)}{H_n^{[2]}{}'(k_3r_0)} & -\frac{nk_z}{r_1k_3^2}\frac{H_n^{[2]}(k_3r_1)}{H_n^{[2]}{}(k_3r_0)} + \frac{nk_z}{r_0k_3^2}\frac{H_n^{[2]}{}'(k_3r_1)}{H_n^{[2]}{}'(k_3r_0)}
        %         \\
        %         0 & \frac{H_n^{[2]}{}(k_3r_0)}{H_n^{[2]}{}(k_3r_0)}
        %     \end{bmatrix}
        % \end{align*}
